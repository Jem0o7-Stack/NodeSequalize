var CompanyType = require('../services').CompanyType;


exports.companyTypeList = (req, res, next) => {
    var query = {};
    ...
    CompanyType.getCompanytypes(query, (ret) => {
        if(ret){
            res.json({
                status: "true",
                data: ret
        ...
        else
		{
			...
			data: ret.errors,
			message: 'Company type list not found!'})
		}
